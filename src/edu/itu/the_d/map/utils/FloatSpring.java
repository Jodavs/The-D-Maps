...
public class FloatSpring {
	 ...
	 *
	 * @param springK  Spring constant, the higher this is the "tighter" the spring, and
	 *                 the more force it will exert for a given extension
	 * @param dampingK Damping constant, the higher this is the stronger the damping, and
	 ...
	 *
	 * @param springK The spring constant - the higher this is, the more quickly the
